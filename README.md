...
![Add file from template using cmd palette](images/file-from-template/add-file-from-template-cmd.png)

![Add file from template using context menu](images/file-from-template/add-file-from-template-folder.png)
